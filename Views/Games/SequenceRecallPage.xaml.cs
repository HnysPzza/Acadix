...
public partial class SequenceRecallPage : ContentPage
{
    private readonly SequenceRecallViewModel _vm;
    public SequenceRecallPage()
    {
        InitializeComponent();
        _vm = new SequenceRecallViewModel();
        BindingContext = _vm;
